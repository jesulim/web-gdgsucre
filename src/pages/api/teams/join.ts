...
export const POST: APIRoute = async ({ request, cookies }) => {
  ...
  try {
    ...
    // TODO: replace with joinTeam func
    console.log(`Uniendose con team code: ${team_code} para el evento: ${event_slug}`)
    ...
    return new Response(`Error al registrar y unirse al equipo: ${error.message || error}`, {
      status: 500,
    })
  }
}
